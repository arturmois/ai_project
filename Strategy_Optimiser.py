...
class StrategyOptimizer:
    ...
    def __init__(
        ...
        self.fitness_funciton = fitness_funciton
    ...
    def create_individual(self):
        ...
        for i in range(self.n_genes):
            gene = np.random.randint(self.gene_ranges[i][0], self.gene_ranges[i][0])
    ...
    def mate_parents(self, parents, n_offspring):
        """ Mates 'parents' and returns 'n_offspring' individuals. """
    ...
    def select_best(self, population, n_best):
        ...
        for idx, individual in enumerate(population):
            individual_fitness = self.fitness_funciton(individual)
        ...
        print('best is: {}, everage: {}, and worst: {}'.format(
            costs_tmp[1].max(),
            costs_tmp[1].mean(),
            costs_tmp[1].min()
        ))
    ...
    def run_genetic_algo(self):
        ...
        parent_gen = self.creat_population(self.generation_size)
